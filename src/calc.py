...
def main():
    ...
    lines.append("| 子系统名称 | 结构可靠度 R_sub(T) |")
    lines.append("|---|---:|")
    ...
    ### 任务 1：建模与公式
     ...
     即λ_effC1 = λC1 ✖ dutyC1 = λC1 ✖ duty = 2.0e-5 ✖ 1 = 2.0e-5 
      λ_effC2 = λC2 ✖ dutyC2 = λC2 ✖ duty = 1.0e-5 ✖ 1 = 1.0e-5
      λ_effC3 = λC3 ✖ dutyC3 = λC3 ✖ duty = 8.0e-5 ✖ 1 = 8.0e-5
      λ_effC4 = λC4 ✖ dutyC4 = λC4 ✖ duty = 8.0e-5 ✖ 1 = 8.0e-5
      λ_effC5 = λC5 ✖ dutyC5 = λC5 ✖ duty = 3.0e-5 ✖ 1 = 3.0e-5
      λ_effC6 = λC6 ✖ dutyC6 = λC6 ✖ duty = 5.0e-5 ✖ 1 = 5.0e-5
      λ_effC7 = λC7 ✖ dutyC7 = λC7 ✖ duty = 4.0e-5 ✖ 1 = 4.0e-5
      λ_effC8 = λC8 ✖ dutyC8 = λC8 ✖ d_H = 1.2e-4 ✖ 0.35 = 4.20e-05
      λ_effC9 = λC9 ✖ dutyC9 = λC9 ✖ d_H = 6.0e-5 ✖ 0.35 = 2.10e-05
      λ_effC10 = λC10 ✖ dutyC10 = λC10 ✖ d_H = 4.0e-5 ✖ 0.35 = 1.40e-05
      λ_effC11 = λC11 ✖ dutyC11 = λC11 ✖ d_H = 3.5e-5 ✖ 0.35 = 1.22e-05
      λ_effC12 = λC12 ✖ dutyC12 = λC12 ✖ d_T = 1.0e-4 ✖ 0.40 = 4.50e-05
      λ_effC13 = λC13 ✖ dutyC13 = λC13 ✖ d_T = 5.0e-5 ✖ 0.40 = 2.25e-05
      λ_effC14 = λC14 ✖ dutyC14 = λC14 ✖ d_T = 2.5e-5 ✖ 0.40 = 1.12e-05
      λ_effC15 = λC15 ✖ dutyC15 = λC15 ✖ duty = 7.0e-5 ✖ 1 = 7.0e-5
      λ_effC16 = λC16 ✖ dutyC16 = λC16 ✖ duty = 7.0e-5 ✖ 1 = 7.0e-5
      λ_effC17 = λC17 ✖ dutyC17 = λC17 ✖ duty = 6.0e-5 ✖ 1 = 6.0e-5 
      λ_effC18 = λC18 ✖ dutyC18 = λC17 ✖ duty = 6.0e-5 ✖ 1 = 6.0e-5 
      λ_effC19 = λC19 ✖ dutyC19 = λC19 ✖ d_G = 6.0e-5 ✖ 0.2 = 1.20e-05
